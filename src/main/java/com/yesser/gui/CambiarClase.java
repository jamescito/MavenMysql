...
public class CambiarClase extends JInternalFrame {
    private static CambiarClase miClase;
    public CambiarClase()
    {
        miClase = this;
    ...
    public static CambiarClase getInstancia()
    {
        return (miClase == null) ? new CambiarClase() : miClase;
    }
